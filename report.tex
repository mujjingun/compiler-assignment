...
"\texttt{globals.h}" -> {"\texttt{util.h}", "\texttt{main.c}"},
...
"\texttt{parser.tab.h}" -> {"\texttt{globals.h}", "\texttt{parser.y}", "\texttt{lex.l}"},
};
...
\lstinputlisting[caption=test\_files/test1.c, frame=single]{test_files/test1.c}
\lstinputlisting[caption=test\_files/test2.c, frame=single]{test_files/test2.c}
